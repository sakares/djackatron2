...
public class TestTransferService {
	...
	public TestTransferService(Account srcAcc, Account desAcc,
			double flatFeePolicy, double amount, 
			double srcBalance, double desBalance) {
		this.srcAcc = srcAcc;
		this.desAcc = desAcc;
	...
	public static Collection<Object[]> primeNumbers() {
		return Arrays
				.asList(new Object[][] {
						{ new Account(1l, "name1", 100d), new Account(2l, "name2", 0d), 5d, 30d, 65d, 30d},
						{ new Account(1l, "name1", 100d), new Account(2l, "name2", 0d), 10d, 50d, 40d, 50d},
				});
	}
